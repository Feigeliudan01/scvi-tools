    ...
    def train(
        ...
        **kwargs
        ...
        super().train(
            ...
            plan_class=SemiSupervisedTrainingPlan,
            plan_kwargs=plan_kwargs,
            train_test_val_kwargs=train_test_val_kwargs,
            trainer_callbacks=sampler_callback,
        )
    ...
    def _train_test_val_split(
        ...
        **kwargs
        ...
        scanvi_train_dl = self._make_data_loader(
            ...
            shuffle=True,
            data_loader_class=dataloader_class,
            drop_last=3,
            **dl_kwargs,
        )
